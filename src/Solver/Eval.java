...
public class Eval {
	...
	public static void initialize() {
		try {
			...
			if (!f.exists()) {
				System.out.println("First time running program.. generating files");
				StateTableEvaluator.handRanks = new int[HAND_RANKS_SIZE];
				StateTableEvaluator.generateTables();
				StateTableEvaluator.saveTables();
			}
